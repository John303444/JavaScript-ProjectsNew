...
let activePlayer = 'X';
//This array stores an array of moves. We use this to determine the win condition.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
     ...
     //to see if it contains the squareNumber clicked on.
     if (!selectedSquares.some(element => element.includes(squareNumber))) {
            //This variable retrieves the HTML element that was clicked on.
            let select = document.getElementById(squareNumber);
            //This condition checks whose turn it is.
            if (activePlayer === 'X') {
                //If it's X's turn, we place an X in the square.
                select.style.backgroundImage = 'url("images/x.png")';
            } else {
                //If it's O's turn, we place an O in the square.
                select.style.backgroundImage = 'url("images/o.png")';
            }
            //squareNumber and activePlayer are concatenated together and added to array.
            selectedSquares.push(squareNumber + activePlayer);
            //This calls a function to check for a win conditions.
            checkWinConditions();
            //This condition is for changing the active player.
            if (activePlayer === 'X') {
                //If active player is'X', we change it to 'O'.      
                activePlayer = 'O';
            ...
            if (activePlayer === 'O') {
                //This function disables clicking while the computer's turn.
                disableClick();
                //This function waits 1 second before the computer places an O in a square.
        ...
        function computersTurn() {
            ...
            while (!success) {
                ...
                //If the random square is empty, we place an O in it.
        ...
        //drawWinLine() function is called to draw the line if a win condition is met.
        function checkWinConditions() {
            ...
            function arrayIncludes(squareA, squareB, squareC) {
                ...
                //If all 3 variables we pass are all included in our array then
        ...
        //This function resets the game after the event of a tie or a win.
        function resetGame() {
